...
public class SegundaActivity extends AppCompatActivity implements View.OnLongClickListener {
    ...
    public void mensaje(){
        ...
        Toast.makeText(getApplicationContext(),"Cosas favoritas: " + '\n' + " Fruta: " +frutas + '\n' + " Animal: " + animals + '\n' + " Lenguaje de programacion: " + lengua , Toast.LENGTH_LONG).show();
    }
